...
FROM node:24.14.1-slim AS base-image
...
# ARG NUXT_PUBLIC_I18N_BASE_URL=https://trapparty.jonas-thelemann.de
...
# EXPOSE 3000
# LABEL org.opencontainers.image.source="https://github.com/dargmuesli/trapparty"
# LABEL org.opencontainers.image.description="TrapParty's website."
